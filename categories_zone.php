<?php
require('header.php');
$start_id = mysqli_real_escape_string($con, $_GET['start_id']);
$end_id = mysqli_real_escape_string($con, $_GET['end_id']);
$get_cat_zone=get_cat_zone($con,'',$start_id, $end_id);
?>
...
<?php if(count($get_cat_zone)>0) { ?>
    ...
    <section id="product1" class="section-p1">
        <div class="pro-container">
            <?php
            foreach($get_cat_zone as $pro_list){
