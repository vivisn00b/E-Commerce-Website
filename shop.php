...
<body>
    ...
    <section id="product1" class="section-p1">
        <div class="pro-container">
            <?php
            $get_product=get_product($con,'all',8);
            foreach($get_product as $list){
                $resAttr=mysqli_query($con,"select mrp,price from product_attributes where product_id='{$list['id']}'");
                $proAttr=[];
                $Mrp=0;
                $Price=0;
            ...
            ?>
            <div class="pro">
                <a href="s-product.php?categories_id=<?php echo $list['categories_id']?>&id=<?php echo $list['id']?>">
                ...
                <a href="s-product.php?categories_id=<?php echo $list['categories_id']?>&id=<?php echo $list['id']?>"><i class="fas fa-cart-plus cart"></i></a>
            </div>
            <?php
            } ?>
        </div>
